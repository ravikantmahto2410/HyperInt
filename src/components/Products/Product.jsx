        ...
        <div className='flex justify-center gap-9 flex-row'>
            <div className=''>
                ...
                <div className="flex items-center mb-3">
                    ...
                    <p className="ms-2 text-sm font-medium text-body mt-2">3000 People</p>
                </div>    
            </div>
            ...
            <div>
                ...
                <div className="flex items-center mb-3">
                    ...
                    <p className="ms-2 text-sm font-medium text-body mt-2">1000 People</p>
                </div>
            </div>
            ...
            <div className="rounded-xl">
                ...
                <div className="flex items-center mb-3">
                    ...
                    <p className="ms-2 text-sm font-medium text-body mt-2">500 People</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex items-center mb-3">
                    ...
                    <p className="ms-2 text-sm font-medium text-body mt-2">250 People</p>
                </div>
            </div>
